...
- **Information Retrieval**: For **LLM Agent** generating reports, how to optimize the usage of offline database via **RAG** (Retrieval Augmented Generation), online web info via **Web Agent** and parametric knowledge, and how to balance the trade-off between token consumptions and report quality can be profound.
