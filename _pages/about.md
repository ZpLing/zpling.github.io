...
- <span class="badge" style="position: relative; display: inline-block; margin-right: 0.5em; margin-top: 0; margin-left: 0;">Preprint</span> **OmniMem: Autoresearch-Guided Discovery of Lifelong Multimodal Agent Memory** [[PDF]](https://arxiv.org/pdf/2604.01007)  [[Code]](https://github.com/aiming-lab/SimpleMem)
...
1. Conducting **Deep Research** based on AI Agent and Retrieval-Augmented Generation (RAG) over intranet databases.
