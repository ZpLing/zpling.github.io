...
- **LLM Agent** and **RAG (Retrieval Augmented Generation)**: For LLM generating reports, how to optimize the usage of offline database, online web info and parametric knowledge, and how to balance the trade-off between token consumptions and report quality is rather deep and profound.
