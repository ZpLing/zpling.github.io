...
- **AI Agent**: Through multi-step decision making, we study how agentic systems can plan,  collaborate and execute with tool-calling to solve complex tasks such as **Deep Research**.
