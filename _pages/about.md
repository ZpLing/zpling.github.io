...
- **LLM Agent & Information Retrieval**: For LLM generating reports, how to optimize the usage of offline database and online web info; how to balance the trade-off between token costs and report quality is rather deep and profound.
