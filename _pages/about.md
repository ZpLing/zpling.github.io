...
- **RAG (Retrieval-Augmented Generation)**: Optimizing how agents leverage databases and how to recall multi-modal data (text, image, audio, video) in a unified form for downstream usage.
